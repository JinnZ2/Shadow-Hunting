...
class StudyInput:
    ...
    claimed_finding: str              # the paper's headline claim
    what_was_measured: str            # the actual physical/behavioral signal
...
# EXAMPLE: THE CHILDHOOD TRAUMA / THREAT RESPONSE STUDY
